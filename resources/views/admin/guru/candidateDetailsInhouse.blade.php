                    ...
                    <tbody >
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                <input type="hidden" id="status_1_" name="attendence[{{$booking->id}}][{{$i}}]" value="0">
                                <input type="checkbox" name="attendence[{{$booking->id}}][{{$i}}]" data-dayindex="{{$i}}" id="{{$booking->id}}" class="attendenceID" value="1" @foreach($booking->getAttendance as $atten)  
